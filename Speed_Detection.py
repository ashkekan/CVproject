...
def trackMultipleObjects(video_frames):
    ...
    for image in video_frames:
        ...
        frame = cv2.resize(frame, (WIDTH, HEIGHT))[cropBegin:720, 0:1280]
        resultImage = blackout(frame)
        ...
        for carID in carTracker.keys():
            ...
            if carID not in startTracker and mark2 > ty + th > mark1 and ty < mark1:
                ...
                if speed > speedLimit:
                    ...
                    saveCar(speed, frame[ty:ty + th, tx:tx + tw])
                else:
